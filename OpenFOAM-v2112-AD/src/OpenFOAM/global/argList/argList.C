...
// Towara: macro expansion string helpers
#define my_str(s) x_str(s)
#define x_str(s) #s
    ...
    if (initialise)
    {
        ...
        if (Pstream::master() && bannerEnabled())
        {
            ...
            Info<< nl
                ...
                << "AD Tool: " << word(my_str(AD_TOOL_VERSION_SHORT)) << nl
        ...
        jobInfo.add("adTool", word(my_str(AD_TOOL_VERSION_SHORT)));
