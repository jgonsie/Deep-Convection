...
static scalar minimaxs(const scalar P)
{
    ...
    const/*expr*/ scalar a_0 = 3.31125922108741;
    const/*expr*/ scalar a_1 = 11.6616720288968;
    const/*expr*/ scalar a_2 = 4.28342155967104;
    const/*expr*/ scalar a_3 = 0.213623493715853;

    const/*expr*/ scalar b_0 = 6.61053765625462;
    const/*expr*/ scalar b_1 = 6.40691597760039;
    const/*expr*/ scalar b_2 = 1.27364489782223;
    const/*expr*/ scalar b_3 = 0.03611708101884203;
