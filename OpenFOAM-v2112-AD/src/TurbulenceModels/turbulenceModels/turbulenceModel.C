...
void Foam::turbulenceModel::kRAM(Foam::dictionary k_dict)
{}

void Foam::turbulenceModel::OmegaRAM(Foam::dictionary Omega_dict)
{}

void Foam::turbulenceModel::nutRAM(Foam::dictionary nut_dict)
{}
// ************************************************************************* //
