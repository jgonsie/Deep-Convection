...
static constexpr scalarPassive oneThird = 1.0 / 3.0;
static constexpr scalarPassive oneSixth = 1.0 / 6.0;
static constexpr scalarPassive twoThird = 2.0 / 3.0;
static constexpr scalarPassive fiveSixth = 5.0 / 6.0;
...
static constexpr scalarPassive ref_X = 0.9505;
static constexpr scalarPassive ref_Y = 1.000;
static constexpr scalarPassive ref_Z = 1.089;
...
static inline scalar gamma_from_xyz(const scalar val)
{
    ...
    (
        val > 0.0031308
      ? scalar(1.055 * (pow(val, scalar(1.0/2.4))) - 0.055)
      : scalar(12.92 * val)
    );
}
