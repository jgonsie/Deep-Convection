...
void Foam::glTF::object::addData(const Type& fld)
{
    ...
    forAll(fld, fieldi)
    {
        ...
        {
            data_[count++] = AD::passiveValue(component(fld[fieldi], d));
        }
    }
}
...
void Foam::glTF::object::addData(const Type1& fld1, const Type2&fld2)
{
    ...
    forAll(fld1, fieldi)
    {
        ...
        {
            data_[count++] = AD::passiveValue(component(fld1[fieldi], d));
        }

        for (direction d = 0; d < nComponents2; ++d)
        {
            data_[count++] = AD::passiveValue(component(fld2[fieldi], d));
        }
    }
}
